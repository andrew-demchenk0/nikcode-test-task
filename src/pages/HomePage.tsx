...
const Profile = lazy(() => import('../components/home/components/ProfileForm.tsx'));
const Favourite = lazy(() => import('../components/home/components/Favourite.tsx'));
	...
	return (
		<>
			<div className='mt-14 flex gap-4 items-center justify-start'>
				...
				<p className='text-sm'>
					Home <span className='text-sm font-bold'>• profile</span>
				</p>
			</div>
